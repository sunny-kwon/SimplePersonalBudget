...
export function BudgetContent({ onboardingCompleted }: { onboardingCompleted: boolean }) {
    ...
    return (
        <div className="space-y-12 pb-20 font-sans">
            {/* Header / Config */}
            <div id="budget-config-panel" className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            {/* Sections */}
            <div id="budget-input-area" className="space-y-4">
